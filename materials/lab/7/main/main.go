...
func main() {
	...
	fmt.Printf("Doing single guesses\n")
	hscan.GuessSingle(drmike1, file)
	hscan.GuessSingle(drmike2, file)
	fmt.Printf("Making hashmaps\n")
	//hscan.GenHashMaps(file)				//without subroutines
	hscan.GenHashMapsWithSubRoutines(file)	//with subroutines
	fmt.Printf("Testing hashmaps\n")
